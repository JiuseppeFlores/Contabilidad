...
function buildTable($el, cells, rows, asientos, tc) {
  ...
  var columns = [
    ...
    {field: "debe",title: "DEBE (Bs.)",align:"right"},
    {field: "haber",title: "HABER (Bs.)",align:"right"},
    {field: "debeDolar",title: "DEBE (SU$)",align:"right"},
    {field: "haberDolar",title: "HABER (SU$)",align:"right"},
