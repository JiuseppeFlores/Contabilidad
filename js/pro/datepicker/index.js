...
import { typeCheckConfig, getjQuery, getUID } from '../../mdb/util/index.js';
import FocusTrap from '../../mdb/util/focusTrap.js';
import {
  getDate,
  getDayNumber,
  getMonth,
...
const Default = {
  ...
  weekdaysFull: ['Domingo', 'Lunes', 'Jueves', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'],
  weekdaysShort: ['Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab'],
  weekdaysNarrow: ['D', 'L', 'M', 'M', 'J', 'V', 'S'],
  okBtnText: 'Establecer',
