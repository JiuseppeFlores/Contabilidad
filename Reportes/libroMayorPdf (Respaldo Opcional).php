    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        if(isset($_POST['codigo']) && isset($_POST['descripcion']) && isset($_POST['fecha_inicial']) && isset($_POST['fecha_final'])){
            ...
            $sql = "SELECT * 
                    ...
                    WHERE tcu.codigo = $codigoCuenta $filtro;";
            ...
            <td colspan="2">NOMBRE ' . $descripcion . '</td>
            </tr>
            <tr style="font-size: 7px;">
            <td></td>
            </tr>
            ...
            echo "El codigo de la cuenta, la descripción, la fecha inicial y final son necesarios.";
