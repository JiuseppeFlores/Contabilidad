...
<body>
    ...
    <script type="text/javascript" src="Cuentas/js/environment.js"></script>
    <script type="text/javascript" src="Cuentas/js/components.js"></script>
    <script type="text/javascript" src="Cuentas/js/app.js"></script>
</html>
